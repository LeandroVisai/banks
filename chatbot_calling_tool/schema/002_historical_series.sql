-- =============================================================================
-- 002_historical_series.sql — series de tiempo macro.
-- IDÉNTICO al chatbot/ clásico: ambas infraestructuras leen de las mismas tablas
-- (`historical_series`, `historical_data`). Ese catálogo es compartido.
-- =============================================================================
